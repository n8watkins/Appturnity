      ...
      <main className="flex-1 py-16 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <p>
              We use Google Analytics to understand how visitors interact with our website. Google Analytics uses cookies
              to collect information such as how often users visit our site, what pages they visit, and what other sites
            ...
            <h2>4. reCAPTCHA</h2>
            <p>
              We use Google reCAPTCHA to protect our contact form from spam and abuse. reCAPTCHA collects hardware
              and software information and sends it to Google for analysis. This information is used solely for
              anti-abuse purposes. Use of reCAPTCHA is subject to the Google Privacy Policy and Terms of Use.
            </p>
            ...
            <ul>
              <li><strong>Service Providers:</strong> We use Resend for email delivery. They process information on our behalf.</li>
            ...
            <p>
              ...
              through your browser settings. However, disabling cookies may limit your ability to use certain features of
              our website.
            </p>
            ...
            <p>
              ...
              California Consumer Privacy Act (CCPA), including the right to know what information we collect and the
