      ...
      <main className="flex-1 py-16 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <p>
              By accessing or using Appturnity's website and services, you agree to be bound by
              these Terms of Use. If you do not agree to these terms, please do not use our
              services.
            </p>

            <h2>2. Description of Services</h2>
            <p>
              Appturnity provides web design and development consulting services, including but not
              limited to:
            </p>
            <ul>
            ...
            <p>
              ...
              the property of Appturnity or its content suppliers and is protected by United States
              and international copyright laws.
            </p>

            <h2>5. Services and Pricing</h2>
            <p>
              All project quotes and pricing information provided on our website or through
              consultations are estimates and subject to change based on project scope and
              requirements. Final pricing will be agreed upon in writing before work begins.
            </p>

            <h2>6. Limitation of Liability</h2>
            <p>
              Appturnity shall not be liable for any indirect, incidental, special, consequential,
              or punitive damages resulting from your use or inability to use our services or
              website.
            </p>
