...
export const ALWAYS_INCLUDED_FEATURES: Feature[] = [
  {
    id: "ssl-hosting",
    name: "SSL & Hosting Setup",
    shortName: "SSL & Hosting",
    description: "Professional configuration of SSL certificate, hosting environment, and domain",
    price: 0,
    saasMonthly: 25,
  ...
  },
  {
    ...
    shortName: "Unlimited Users",
    description: "No limits on team members or users",
    price: 0,
    saasMonthly: 0,
    category: "Always Included",
    isAlwaysIncluded: true,
  },
  {
    ...
    shortName: "Code Ownership",
    description: "You own 100% of the code",
    price: 0,
    saasMonthly: 0,
    category: "Always Included",
    isAlwaysIncluded: true,
