                  ...
                  <div className="space-y-6 mb-12">
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-slate-400 text-sm">
                          No monthly subscriptions or per-user fees. Your code, your data, your
                          freedom.
                        </p>
                      </div>
                    </motion.div>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-slate-400 text-sm">
                          Custom solutions designed around your specific needs, not generic
                          templates.
                        </p>
                      </div>
                    </motion.div>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-slate-400 text-sm">
                          Most projects delivered in 2-8 weeks. Get to market faster than
                          competitors.
                        </p>
                      </div>
                    </motion.div>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-slate-400 text-sm">
                          Know exactly what you're paying upfront. No hidden fees or surprise
                          charges.
                        </p>
                      </div>
                    </motion.div>
